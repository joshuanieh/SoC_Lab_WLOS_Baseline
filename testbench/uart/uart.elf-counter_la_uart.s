...
.Ltext0:
	...
	.file 0 "/mnt/c/Users/nieh/Documents/Joshuanieh/GIEE/Soc_Design_Lab/SoC_Lab_WLOS_Baseline/testbench/uart" "counter_la_uart.c"
	.align	2
...
.L9:
	...
	j	.L10
.L11:
	.loc 5 148 45 discriminator 3
	lw	a5,-20(s0)
	slli	a5,a5,2
	lw	a4,-28(s0)
	add	a5,a4,a5
	.loc 5 148 39 discriminator 3
	lw	a5,0(a5)
	.loc 5 148 49 discriminator 3
	slli	a4,a5,16
	.loc 5 148 4 discriminator 3
	li	a5,637534208
	addi	a5,a5,12
	.loc 5 148 37 discriminator 3
	sw	a4,0(a5)
	.loc 5 147 18 discriminator 3
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L10:
	.loc 5 147 12 discriminator 1
	lw	a4,-20(s0)
	li	a5,15
	ble	a4,a5,.L11
	.loc 5 154 3
	...
	j	.L12
.L13:
	.loc 5 160 45 discriminator 3
	lw	a5,-20(s0)
	slli	a5,a5,2
	lw	a4,-32(s0)
	add	a5,a4,a5
	.loc 5 160 39 discriminator 3
	lw	a5,0(a5)
	.loc 5 160 49 discriminator 3
	slli	a4,a5,16
	.loc 5 160 4 discriminator 3
	li	a5,637534208
	addi	a5,a5,12
	.loc 5 160 37 discriminator 3
	sw	a4,0(a5)
	.loc 5 159 18 discriminator 3
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L12:
	.loc 5 159 12 discriminator 1
	lw	a4,-20(s0)
	li	a5,9
	ble	a4,a5,.L13
	.loc 5 172 3
...
.L15:
	...
	sw	a4,0(a5)
	.loc 5 177 18 discriminator 3
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L14:
	.loc 5 177 12 discriminator 1
	lw	a4,-20(s0)
	li	a5,10
	ble	a4,a5,.L15
	.loc 5 191 3
